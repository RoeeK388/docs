...
Custom Scripts let you add browser-side HTML/JavaScript to Jurni storefront funnels when a vendor or internal analytics implementation does not have a dedicated Jurni integration.
