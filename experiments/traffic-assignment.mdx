...
Jurni is designed to avoid unnecessarily switching the same visitor between variants during the same experiment. This protects the shopper experience and keeps the experiment easier to interpret.

If you are manually testing different variants, use the experiment's preview or testing workflow rather than repeatedly refreshing the production Smart Link and expecting a new variant on every load.
